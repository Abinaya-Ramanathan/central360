    ...
    return FixedHeaderTable(
      ...
      headerBuilder: (ctx) => Row(
        children: [
          ...
          const SizedBox(width: _salesSp),
          const SizedBox(width: _salesWAddr, height: 48, child: Align(alignment: Alignment.centerLeft, child: Text('Address', style: TextStyle(fontWeight: FontWeight.bold)))),
          const SizedBox(width: _salesSp),
          const SizedBox(width: _salesWProduct, height: 48, child: Align(alignment: Alignment.centerLeft, child: Text('Product Name', style: TextStyle(fontWeight: FontWeight.bold)))),
          const SizedBox(width: _salesSp),
          const SizedBox(width: _salesWQty, height: 48, child: Align(alignment: Alignment.centerLeft, child: Text('Quantity', style: TextStyle(fontWeight: FontWeight.bold)))),
          const SizedBox(width: _salesSp),
          const SizedBox(width: _salesWAmt, height: 48, child: Align(alignment: Alignment.centerLeft, child: Text('Amount Received', style: TextStyle(fontWeight: FontWeight.bold)))),
          const SizedBox(width: _salesSp),
          const SizedBox(width: _salesWCredit, height: 48, child: Align(alignment: Alignment.centerLeft, child: Text('Credit Amount', style: TextStyle(fontWeight: FontWeight.bold)))),
          const SizedBox(width: _salesSp),
          const SizedBox(width: _salesWAction, height: 48, child: Align(alignment: Alignment.centerLeft, child: Text('Action', style: TextStyle(fontWeight: FontWeight.bold)))),
        ],
      ),
    ...
    return FixedHeaderTable(
      ...
      headerBuilder: (ctx) => Row(
        children: [
          ...
          const SizedBox(width: _purchaseSp),
          const SizedBox(width: _purchaseWAmount, height: 48, child: Align(alignment: Alignment.centerLeft, child: Text('Purchase Amount', style: TextStyle(fontWeight: FontWeight.bold)))),
          const SizedBox(width: _purchaseSp),
          const SizedBox(width: _purchaseWCredit, height: 48, child: Align(alignment: Alignment.centerLeft, child: Text('Credit', style: TextStyle(fontWeight: FontWeight.bold)))),
          const SizedBox(width: _purchaseSp),
          const SizedBox(width: _purchaseWBill, height: 48, child: Align(alignment: Alignment.centerLeft, child: Text('Bill Image', style: TextStyle(fontWeight: FontWeight.bold)))),
          const SizedBox(width: _purchaseSp),
          const SizedBox(width: _purchaseWAction, height: 48, child: Align(alignment: Alignment.centerLeft, child: Text('Action', style: TextStyle(fontWeight: FontWeight.bold)))),
        ],
      ),
    ...
    return FixedHeaderTable(
      ...
      headerBuilder: (ctx) => Row(
        children: [
          ...
          const SizedBox(width: _summarySp),
          const SizedBox(width: _summaryWPurchaseExp, height: 48, child: Align(alignment: Alignment.centerLeft, child: Text('Purchase Expense', style: TextStyle(fontWeight: FontWeight.bold)))),
          const SizedBox(width: _summarySp),
          const SizedBox(width: _summaryWPurchaseCredit, height: 48, child: Align(alignment: Alignment.centerLeft, child: Text('Purchase Credit', style: TextStyle(fontWeight: FontWeight.bold)))),
          const SizedBox(width: _summarySp),
          const SizedBox(width: _summaryWCreditPaid, height: 48, child: Align(alignment: Alignment.centerLeft, child: Text('Purchase Credit Paid', style: TextStyle(fontWeight: FontWeight.bold)))),
        ],
      ),
      rowCount: rowCount,
