    ...
    return FixedHeaderTable(
      ...
      headerBuilder: (ctx) => Row(
        children: [
          ...
          const SizedBox(width: _companyPurchaseSp),
          const SizedBox(width: _companyPurchaseWAmount, height: 48, child: Align(alignment: Alignment.centerLeft, child: Text('Purchase Amount', style: TextStyle(fontWeight: FontWeight.bold)))),
          const SizedBox(width: _companyPurchaseSp),
          const SizedBox(width: _companyPurchaseWPaid, height: 48, child: Align(alignment: Alignment.centerLeft, child: Text('Amount Paid', style: TextStyle(fontWeight: FontWeight.bold)))),
          const SizedBox(width: _companyPurchaseSp),
          const SizedBox(width: _companyPurchaseWCredit, height: 48, child: Align(alignment: Alignment.centerLeft, child: Text('Credit', style: TextStyle(fontWeight: FontWeight.bold)))),
          const SizedBox(width: _companyPurchaseSp),
          const SizedBox(width: _companyPurchaseWBill, height: 48, child: Align(alignment: Alignment.centerLeft, child: Text('Bill Image', style: TextStyle(fontWeight: FontWeight.bold)))),
          const SizedBox(width: _companyPurchaseSp),
          const SizedBox(width: _companyPurchaseWAction, height: 48, child: Align(alignment: Alignment.centerLeft, child: Text('Action', style: TextStyle(fontWeight: FontWeight.bold)))),
        ],
      ),
