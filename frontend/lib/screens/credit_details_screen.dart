                              ...
                              child: FixedHeaderTable(
                                ...
                                headerBuilder: (ctx) {
                                  final headers = <Widget>[
                                    ...
                                    const SizedBox(width: colSpace),
                                    const SizedBox(width: wAddress, height: 48, child: Text('Address', style: TextStyle(fontWeight: FontWeight.bold))),
                                    const SizedBox(width: colSpace),
                                    const SizedBox(width: wPurchaseDetails, height: 48, child: Text('Purchase Details', style: TextStyle(fontWeight: FontWeight.bold))),
                                    const SizedBox(width: colSpace),
                                    const SizedBox(width: wCreditAmount, height: 48, child: Text('Credit Amount', style: TextStyle(fontWeight: FontWeight.bold))),
                                    const SizedBox(width: colSpace),
                                    InkWell(
                                      onTap: () => setState(() {
                                    ...
                                    const SizedBox(width: colSpace),
                                    const SizedBox(width: wFullSettlementDate, height: 48, child: Text('Full Settlement Date', style: TextStyle(fontWeight: FontWeight.bold))),
                                    const SizedBox(width: colSpace),
                                    const SizedBox(width: wPendingAmount, height: 48, child: Text('Pending Amount', style: TextStyle(fontWeight: FontWeight.bold))),
                                    const SizedBox(width: colSpace),
                                    const SizedBox(width: wComments, height: 48, child: Text('Comments', style: TextStyle(fontWeight: FontWeight.bold))),
                                    const SizedBox(width: colSpace),
                                    const SizedBox(width: wAction, height: 48, child: Text('Action', style: TextStyle(fontWeight: FontWeight.bold))),
                                  ];
