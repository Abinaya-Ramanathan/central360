# Company360 v1.0.7 Release Guide
...
1. **Update version numbers** (already done):
   - `frontend/pubspec.yaml`: `version: 1.0.7+8`
   - `backend/src/routes/app.routes.js`: `version: '1.0.7'`, `buildNumber: '8'`
   - `frontend/setup.iss`: `AppVersion=1.0.7`
...
3. **Build Android:**
   ...
   # Copy APK
   copy build\app\outputs\flutter-apk\app-release.apk company360-v1.0.7.apk
   ```
...
3. **Android APK:**
   - `frontend/company360-v1.0.7.apk`
...
- [ ] Test Android APK
- [ ] Create GitHub release tag: `v1.0.7`
- [ ] Upload `Company360-Setup.exe` to GitHub release
- [ ] Upload `company360-v1.0.7.apk` to GitHub release
