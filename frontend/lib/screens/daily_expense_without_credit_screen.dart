...
class DailyExpenseWithoutCreditScreen extends StatefulWidget {
  ...
  const DailyExpenseWithoutCreditScreen({
    super.key,
  ...
  @override
  State<DailyExpenseWithoutCreditScreen> createState() => _DailyExpenseWithoutCreditScreenState();
}

class _DailyExpenseWithoutCreditScreenState extends State<DailyExpenseWithoutCreditScreen> {
  int? _selectedMonth;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Daily Expense without Credit Details'),
